...
def forecast_usd():
    ...
    data = yf.download('USDIDR=X', start='2020-01-01', end='2024-09-01', interval='1mo')
    ...
    forecast_df = pd.DataFrame(forecast.values, index=forecast_dates, columns=['Forecasted USD/IDR'])
